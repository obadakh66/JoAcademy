...
var AabuCumulatorPage = /** @class */ (function () {
    function AabuCumulatorPage(langService, loadingController, modalController) {
    ...
    AabuCumulatorPage.prototype.ngOnInit = function () {
    ...
    Object.defineProperty(AabuCumulatorPage.prototype, "currentGpa", {
        get: function () {
    ...
    Object.defineProperty(AabuCumulatorPage.prototype, "noOfHoursIncluded", {
        get: function () {
    ...
    AabuCumulatorPage.prototype.addCourse = function () {
    ...
    AabuCumulatorPage.prototype.scrollToBottom = function () {
        var _this = this;
        setTimeout(function () {
    ...
    AabuCumulatorPage.prototype.presentLoading = function () {
    ...
    AabuCumulatorPage.prototype.presentResult = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var modal;
    ...
    AabuCumulatorPage.prototype.removeCourse = function (course) {
    ...
    AabuCumulatorPage.prototype.isArabic = function () {
        return this.langService.isArabic();
    };
    AabuCumulatorPage.prototype.calculate = function () {
        var _this = this;
    ...
    AabuCumulatorPage.prototype.checkFormControlValidaty = function (name, id) {
    ...
    AabuCumulatorPage = tslib_1.__decorate([
        Component({
            selector: 'app-aabu-cumulator',
            templateUrl: './aabu-cumulator.page.html',
            styleUrls: ['./aabu-cumulator.page.scss'],
        }),
        tslib_1.__metadata("design:paramtypes", [LanguageService,
            LoadingController,
            ModalController])
    ], AabuCumulatorPage);
    return AabuCumulatorPage;
}());
export { AabuCumulatorPage };
//# sourceMappingURL=aabu-cumulator.page.js.map