...
var BauCumulatorPage = /** @class */ (function () {
    function BauCumulatorPage(langService, loadingController, modalController) {
    ...
    BauCumulatorPage.prototype.ngOnInit = function () {
    ...
    Object.defineProperty(BauCumulatorPage.prototype, "currentGpa", {
        get: function () {
    ...
    Object.defineProperty(BauCumulatorPage.prototype, "noOfHoursIncluded", {
        get: function () {
    ...
    BauCumulatorPage.prototype.addCourse = function () {
    ...
    BauCumulatorPage.prototype.scrollToBottom = function () {
        var _this = this;
        setTimeout(function () {
    ...
    BauCumulatorPage.prototype.presentLoading = function () {
    ...
    BauCumulatorPage.prototype.presentResult = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var modal;
            var _this = this;
    ...
    BauCumulatorPage.prototype.removeCourse = function (course) {
    ...
    BauCumulatorPage.prototype.isArabic = function () {
        return this.langService.isArabic();
    };
    BauCumulatorPage.prototype.calculate = function () {
        var _this = this;
    ...
    BauCumulatorPage.prototype.checkFormControlValidaty = function (name, id) {
    ...
    BauCumulatorPage = tslib_1.__decorate([
        Component({
            selector: 'app-bau-cumulator',
            templateUrl: './bau-cumulator.page.html',
            styleUrls: ['./bau-cumulator.page.scss'],
        }),
        tslib_1.__metadata("design:paramtypes", [LanguageService,
            LoadingController,
            ModalController])
    ], BauCumulatorPage);
    return BauCumulatorPage;
}());
export { BauCumulatorPage };
//# sourceMappingURL=bau-cumulator.page.js.map