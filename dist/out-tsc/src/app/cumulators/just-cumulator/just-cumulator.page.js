...
var JustCumulatorPage = /** @class */ (function () {
    function JustCumulatorPage(langService, loadingController, modalController) {
    ...
    JustCumulatorPage.prototype.ngOnInit = function () {
    ...
    Object.defineProperty(JustCumulatorPage.prototype, "currentGpa", {
        get: function () {
    ...
    Object.defineProperty(JustCumulatorPage.prototype, "noOfHoursIncluded", {
        get: function () {
    ...
    JustCumulatorPage.prototype.addCourse = function () {
    ...
    JustCumulatorPage.prototype.scrollToBottom = function () {
        var _this = this;
        setTimeout(function () {
    ...
    JustCumulatorPage.prototype.presentLoading = function () {
    ...
    JustCumulatorPage.prototype.presentResult = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var modal;
            var _this = this;
    ...
    JustCumulatorPage.prototype.removeCourse = function (course) {
    ...
    JustCumulatorPage.prototype.isArabic = function () {
        return this.langService.isArabic();
    };
    JustCumulatorPage.prototype.calculate = function () {
        var _this = this;
    ...
    JustCumulatorPage.prototype.checkFormControlValidaty = function (name, id) {
    ...
    ], JustCumulatorPage.prototype, "ionContent", void 0);
    JustCumulatorPage = tslib_1.__decorate([
        Component({
    ...
    return JustCumulatorPage;
}());
export { JustCumulatorPage };
//# sourceMappingURL=just-cumulator.page.js.map