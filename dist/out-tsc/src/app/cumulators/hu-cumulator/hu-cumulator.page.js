...
var HuCumulatorPage = /** @class */ (function () {
    function HuCumulatorPage(langService, loadingController, modalController) {
    ...
    HuCumulatorPage.prototype.ngOnInit = function () {
    ...
    Object.defineProperty(HuCumulatorPage.prototype, "currentGpa", {
        get: function () {
    ...
    Object.defineProperty(HuCumulatorPage.prototype, "noOfHoursIncluded", {
        get: function () {
    ...
    HuCumulatorPage.prototype.addCourse = function () {
    ...
    HuCumulatorPage.prototype.scrollToBottom = function () {
        var _this = this;
        setTimeout(function () {
    ...
    HuCumulatorPage.prototype.presentLoading = function () {
    ...
    HuCumulatorPage.prototype.presentResult = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var modal;
            var _this = this;
    ...
    HuCumulatorPage.prototype.removeCourse = function (course) {
    ...
    HuCumulatorPage.prototype.isArabic = function () {
        return this.langService.isArabic();
    };
    HuCumulatorPage.prototype.calculate = function () {
        var _this = this;
    ...
    HuCumulatorPage.prototype.checkFormControlValidaty = function (name, id) {
    ...
    ], HuCumulatorPage.prototype, "ionContent", void 0);
    HuCumulatorPage = tslib_1.__decorate([
        Component({
            selector: 'app-hu-cumulator',
            templateUrl: './hu-cumulator.page.html',
            styleUrls: ['./hu-cumulator.page.scss'],
        }),
        tslib_1.__metadata("design:paramtypes", [LanguageService,
            LoadingController,
            ModalController])
    ], HuCumulatorPage);
    return HuCumulatorPage;
}());
export { HuCumulatorPage };
//# sourceMappingURL=hu-cumulator.page.js.map