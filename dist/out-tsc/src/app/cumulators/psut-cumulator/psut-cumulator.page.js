...
var PsutCumulatorPage = /** @class */ (function () {
    function PsutCumulatorPage(langService, loadingController, modalController) {
    ...
    PsutCumulatorPage.prototype.ngOnInit = function () {
    ...
    Object.defineProperty(PsutCumulatorPage.prototype, "currentGpa", {
        get: function () {
    ...
    Object.defineProperty(PsutCumulatorPage.prototype, "noOfHoursIncluded", {
        get: function () {
    ...
    PsutCumulatorPage.prototype.addCourse = function () {
    ...
    PsutCumulatorPage.prototype.scrollToBottom = function () {
        var _this = this;
        setTimeout(function () {
    ...
    PsutCumulatorPage.prototype.presentLoading = function () {
    ...
    PsutCumulatorPage.prototype.presentResult = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var modal;
    ...
    PsutCumulatorPage.prototype.removeCourse = function (course) {
    ...
    PsutCumulatorPage.prototype.isArabic = function () {
        return this.langService.isArabic();
    };
    PsutCumulatorPage.prototype.calculate = function () {
        var _this = this;
    ...
    PsutCumulatorPage.prototype.checkFormControlValidaty = function (name, id) {
    ...
    ], PsutCumulatorPage.prototype, "ionContent", void 0);
    PsutCumulatorPage = tslib_1.__decorate([
        Component({
            selector: 'app-psut-cumulator',
            templateUrl: './psut-cumulator.page.html',
            styleUrls: ['./psut-cumulator.page.scss'],
        }),
        tslib_1.__metadata("design:paramtypes", [LanguageService,
            LoadingController,
            ModalController])
    ], PsutCumulatorPage);
    return PsutCumulatorPage;
}());
export { PsutCumulatorPage };
//# sourceMappingURL=psut-cumulator.page.js.map