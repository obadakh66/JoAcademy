...
var YuCumulatorPage = /** @class */ (function () {
    function YuCumulatorPage(langService, loadingController, modalController) {
    ...
    YuCumulatorPage.prototype.ngOnInit = function () {
    ...
    Object.defineProperty(YuCumulatorPage.prototype, "currentGpa", {
        get: function () {
    ...
    Object.defineProperty(YuCumulatorPage.prototype, "noOfHoursIncluded", {
        get: function () {
    ...
    YuCumulatorPage.prototype.addCourse = function () {
    ...
    YuCumulatorPage.prototype.scrollToBottom = function () {
        var _this = this;
        setTimeout(function () {
    ...
    YuCumulatorPage.prototype.presentLoading = function () {
    ...
    YuCumulatorPage.prototype.presentResult = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var modal;
    ...
    YuCumulatorPage.prototype.removeCourse = function (course) {
    ...
    YuCumulatorPage.prototype.isArabic = function () {
        return this.langService.isArabic();
    };
    YuCumulatorPage.prototype.calculate = function () {
        var _this = this;
    ...
    YuCumulatorPage.prototype.checkFormControlValidaty = function (name, id) {
    ...
    YuCumulatorPage = tslib_1.__decorate([
        Component({
            selector: 'app-yu-cumulator',
            templateUrl: './yu-cumulator.page.html',
            styleUrls: ['./yu-cumulator.page.scss'],
        }),
        tslib_1.__metadata("design:paramtypes", [LanguageService,
            LoadingController,
            ModalController])
    ], YuCumulatorPage);
    return YuCumulatorPage;
}());
export { YuCumulatorPage };
//# sourceMappingURL=yu-cumulator.page.js.map