...
var MutahCumulatorPage = /** @class */ (function () {
    function MutahCumulatorPage(langService, loadingController, modalController) {
    ...
    MutahCumulatorPage.prototype.ngOnInit = function () {
    ...
    Object.defineProperty(MutahCumulatorPage.prototype, "currentGpa", {
        get: function () {
    ...
    Object.defineProperty(MutahCumulatorPage.prototype, "noOfHoursIncluded", {
        get: function () {
    ...
    MutahCumulatorPage.prototype.addCourse = function () {
    ...
    MutahCumulatorPage.prototype.scrollToBottom = function () {
        var _this = this;
        setTimeout(function () {
    ...
    MutahCumulatorPage.prototype.presentLoading = function () {
    ...
    MutahCumulatorPage.prototype.presentResult = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var modal;
    ...
    MutahCumulatorPage.prototype.removeCourse = function (course) {
    ...
    MutahCumulatorPage.prototype.isArabic = function () {
        return this.langService.isArabic();
    };
    MutahCumulatorPage.prototype.calculate = function () {
        var _this = this;
    ...
    MutahCumulatorPage.prototype.checkFormControlValidaty = function (name, id) {
    ...
    ], MutahCumulatorPage.prototype, "ionContent", void 0);
    MutahCumulatorPage = tslib_1.__decorate([
        Component({
            selector: 'app-mutah-cumulator',
            templateUrl: './mutah-cumulator.page.html',
            styleUrls: ['./mutah-cumulator.page.scss'],
        }),
        tslib_1.__metadata("design:paramtypes", [LanguageService,
            LoadingController,
            ModalController])
    ], MutahCumulatorPage);
    return MutahCumulatorPage;
}());
export { MutahCumulatorPage };
//# sourceMappingURL=mutah-cumulator.page.js.map