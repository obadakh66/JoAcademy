...
var AhuCumulatorPage = /** @class */ (function () {
    function AhuCumulatorPage(langService, loadingController, modalController) {
        ...
        this.mainNumbersForm = new FormGroup({
            ...
            noOfHoursIncluded: new FormControl('', [Validators.required, Validators.minLength(2), Validators.maxLength(3)])
        });
        this.formTemplate = form_template;
    }
    AhuCumulatorPage.prototype.ngOnInit = function () {
    ...
    Object.defineProperty(AhuCumulatorPage.prototype, "currentGpa", {
        get: function () {
    ...
    Object.defineProperty(AhuCumulatorPage.prototype, "noOfHoursIncluded", {
        get: function () {
    ...
    AhuCumulatorPage.prototype.addCourse = function () {
    ...
    AhuCumulatorPage.prototype.scrollToBottom = function () {
        var _this = this;
        setTimeout(function () {
    ...
    AhuCumulatorPage.prototype.presentLoading = function () {
    ...
    AhuCumulatorPage.prototype.presentResult = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var modal;
            var _this = this;
    ...
    AhuCumulatorPage.prototype.removeCourse = function (course) {
    ...
    AhuCumulatorPage.prototype.isArabic = function () {
        return this.langService.isArabic();
    };
    AhuCumulatorPage.prototype.calculate = function () {
        var _this = this;
    ...
    AhuCumulatorPage.prototype.checkFormControlValidaty = function (name, id) {
    ...
    ], AhuCumulatorPage.prototype, "ionContent", void 0);
    AhuCumulatorPage = tslib_1.__decorate([
        Component({
            selector: 'app-ahu-cumulator',
            templateUrl: './ahu-cumulator.page.html',
    ...
    return AhuCumulatorPage;
}());
export { AhuCumulatorPage };
//# sourceMappingURL=ahu-cumulator.page.js.map